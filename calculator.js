...
*/
let feld1 = document.getElementById("Währung1");
let feld2 = document.getElementById("Währung2");
let rate = document.getElementById("Wechsel_rate");
let idTabelle = document.getElementById("tabelle_erzeugen");
let current = false;
...
function tableCreate() {
    ...
    let tabelleTop = document.createElement("table");
    ...
    let wechselRate = document.getElementById("Wechsel");
    ...
    let tabelle0 = document.querySelector("table");
